...
class RegisterPageWin extends StatefulWidget {
  const RegisterPageWin({super.key});

  @override
  State<RegisterPageWin> createState() => _LoginPage();
}

class _LoginPage extends State<RegisterPageWin> {
